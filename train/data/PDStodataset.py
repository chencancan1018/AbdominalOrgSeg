    ...
    def __getitem__(self, index):
        ...
        with torch.no_grad():
            ...
            seg = data["seg"]
             ...
             # for pancreas and duodenum and stomach
            rand_z = random.randint(4, 9); rand_yx = random.randint(20, 70)
            pmin, pmax = self.find_valid_region(seg.copy(), values=[4, 11, 12], low_margin=[rand_z,rand_yx,rand_yx], up_margin=[rand_z,rand_yx,rand_yx])
            ...
            seg_[seg == 4] = 1; seg_[seg == 11] = 2; seg_[seg == 12] = 3
