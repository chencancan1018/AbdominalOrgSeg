...
class AIVCSegDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        with torch.no_grad():
            ...
            pmin, pmax = self.find_valid_region(seg.copy(), values=[5,6], low_margin=[rand_z,rand_yx,rand_yx], up_margin=[rand_z,rand_yx,rand_yx])
